...
export default function Admin() {
  ...
  async function loadAll() {
    ...
    try {
      ...
      const [subRes, canRes, catRes] = await Promise.all([
    ...
    <div className="container" style={{ padding: '32px 24px' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        <div>
          ...
          <p style={{ color: '#9A9488', fontSize: 14 }}>Manage votes, candidates & categories</p>
        </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 16, marginBottom: 32 }}>
        {[
          ...
          <div key={s.label} style={{ background: '#161616', border: '1px solid #2A2A2A', borderRadius: 12, padding: '20px 20px' }}>
      ...
      {/* Tabs */}
      <div style={{ display: 'flex', gap: 4, background: '#161616', borderRadius: 10, padding: 4, marginBottom: 28, width: 'fit-content' }}>
        {['submissions', 'candidates', 'categories'].map(t => (
                  ...
                  <div key={s._id} style={{
                    ...
                    <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'flex-start', gap: 12 }}>
                      <div>
                        ...
                        <div style={{ fontSize: 12, color: '#9A9488', marginTop: 4 }}>
